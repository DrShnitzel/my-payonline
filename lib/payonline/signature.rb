module Payonline
  class Signature
    ...
    def prepare_params(params, add_merchant_id = true)
      if add_merchant_id
        merchant_id = params[:merchant_id] || Payonline.configuration.merchant_id
        params.reverse_merge!(merchant_id: merchant_id)
    ...
    def digest_data
      ...
      digest_params[:private_security_key] = @params[:private_security_key] || Payonline.configuration.private_security_key
